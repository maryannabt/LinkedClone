...
import MessageImg from "../../img/userpage_message_img.svg";
    ...
    return (
      <Wrapper>
        ...
        <UL showMore={this.state.showMore}>
          <LI>
            <LiImgDiv>
              <LiConImg1 src={MyProfile} />
              <LiConImg2 src={MyProfile} />
            </LiImgDiv>
            <LiText>
              <TextTitle>0 Mutual Connections</TextTitle>
              <TextText>
                {" "}
                You and {selectedUser.first_name} both know #### #### and 0
                others
              </TextText>
            </LiText>
          </LI>
          ...
          <LI>
            ...
            <LiText>
              <TextTitle>
                Reach out to {selectedUser.first_name} for...
              </TextTitle>
